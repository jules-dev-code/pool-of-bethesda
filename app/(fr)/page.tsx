  ...
  return (
    <>
      ...
      <AboutPreview
        ...
        quote={t.about.quote}
      />
      <ServicesGrid locale="fr" title={t.services.title} ctaLabel={t.services.cta} />
      ...
      />
      <TestimonialsSection locale="fr" title={t.testimonials.title} />
      <GallerySection title={t.gallery.title} />
      <FaqSection locale="fr" title={t.faq.title} limit={5} />
      <CtaSection locale="fr" title={t.cta.title} buttonLabel={t.cta.button} />
    </>
  );
}
